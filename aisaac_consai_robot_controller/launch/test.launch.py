...
def generate_launch_description():
    pid_gains = os.path.join(
        get_package_share_directory('aisaac_consai_robot_controller'),
        'config',
        'control_params.yaml'
        )
    ...
    container = ComposableNodeContainer(
            ...
            composable_node_descriptions=[
                ComposableNode(
                    package='aisaac_consai_robot_controller',
                    plugin='aisaac_consai_robot_controller::Controller',
                    name='controller',
                ...
                ComposableNode(
                    package='aisaac_consai_robot_controller',
                    plugin='aisaac_consai_robot_controller::GrSimCommandConverter',
