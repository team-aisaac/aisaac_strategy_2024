...
#include "aisaac_consai_robot_controller/grsim_command_converter.hpp"
...
RCLCPP_COMPONENTS_REGISTER_NODE(aisaac_consai_robot_controller::GrSimCommandConverter)
